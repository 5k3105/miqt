...
// GetDecodedMetricF can only be called from a QBitmap that was directly constructed.
func (this *QBitmap) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QBitmap_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QBitmap) callVirtualBase_Metric(param1 PaintDeviceMetric) int {
	...
	return (int)(C.QBitmap_virtualbase_metric(unsafe.Pointer(this.h), param1))
...
func miqt_exec_callback_QBitmap_metric(self *C.QBitmap, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
