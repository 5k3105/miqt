...
func (this *QColumnView) ScrollTo(index *QModelIndex, hint ScrollHint) {
	C.QColumnView_scrollTo(this.h, index.cPointer(), hint)
}
...
func (this *QColumnView) SetPreviewColumnVisible(visible bool) {
	C.QColumnView_setPreviewColumnVisible(this.h, (C.bool)(visible))
}

func (this *QColumnView) IsPreviewColumnVisible() bool {
	return (bool)(C.QColumnView_isPreviewColumnVisible(this.h))
}
...
func (this *QColumnView) State() State {
...
func (this *QColumnView) SetState(state State) {

	var _dynamic_cast_ok C.bool = false
	C.QColumnView_protectedbase_setState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
...
func (this *QColumnView) DropIndicatorPosition() DropIndicatorPosition {
...
// GetDecodedMetricF can only be called from a QColumnView that was directly constructed.
func (this *QColumnView) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QColumnView_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QColumnView) callVirtualBase_ScrollTo(index *QModelIndex, hint ScrollHint) {
	...
	C.QColumnView_virtualbase_scrollTo(unsafe.Pointer(this.h), index.cPointer(), hint)
...
func miqt_exec_callback_QColumnView_scrollTo(self *C.QColumnView, cb C.intptr_t, index *C.QModelIndex, hint C.ScrollHint) {
...
func (this *QColumnView) callVirtualBase_MoveCursor(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex {
	...
	_goptr := newQModelIndex(C.QColumnView_virtualbase_moveCursor(unsafe.Pointer(this.h), cursorAction, (C.int)(modifiers)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func miqt_exec_callback_QColumnView_moveCursor(self *C.QColumnView, cb C.intptr_t, cursorAction C.CursorAction, modifiers C.int) *C.QModelIndex {
...
func (this *QColumnView) callVirtualBase_Edit2(index *QModelIndex, trigger EditTrigger, event *QEvent) bool {
	...
	return (bool)(C.QColumnView_virtualbase_edit2(unsafe.Pointer(this.h), index.cPointer(), trigger, event.cPointer()))
...
func miqt_exec_callback_QColumnView_edit2(self *C.QColumnView, cb C.intptr_t, index *C.QModelIndex, trigger C.EditTrigger, event *C.QEvent) C.bool {
...
func (this *QColumnView) callVirtualBase_SelectionCommand(index *QModelIndex, event *QEvent) SelectionFlag {
	...
	return (SelectionFlag)(C.QColumnView_virtualbase_selectionCommand(unsafe.Pointer(this.h), index.cPointer(), event.cPointer()))
...
func (this *QColumnView) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QColumnView_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QColumnView) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QColumnView_metric(self *C.QColumnView, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
