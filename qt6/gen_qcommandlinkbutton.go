...
// GetDecodedMetricF can only be called from a QCommandLinkButton that was directly constructed.
func (this *QCommandLinkButton) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QCommandLinkButton_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QCommandLinkButton) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QCommandLinkButton_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QCommandLinkButton) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QCommandLinkButton_metric(self *C.QCommandLinkButton, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
