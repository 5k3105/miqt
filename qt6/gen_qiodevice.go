...
return _ret}
			...
			func (this *QIODevice) OpenMode() OpenModeFlag {
				return (OpenModeFlag)(C.QIODevice_openMode(this.h))
}
...
return _ret}
			...
			func (this *QIODevice) ReadLineIntoWithBuffer(buffer QSpan<char>) *QByteArrayView {
				_goptr := newQByteArrayView(C.QIODevice_readLineIntoWithBuffer(this.h, buffer))
_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
return _goptr
}
			
			func (this *QIODevice) ReadLineInto2(buffer QSpan<uchar>) *QByteArrayView {
				_goptr := newQByteArrayView(C.QIODevice_readLineInto2(this.h, buffer))
_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
return _goptr
}
			
			func (this *QIODevice) ReadLineInto3(buffer QSpan<std__byte>) *QByteArrayView {
				_goptr := newQByteArrayView(C.QIODevice_readLineInto3(this.h, buffer))
_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
return _goptr
}
...
return _ret}
			...
			func (this *QIODevice) SetOpenMode (openMode OpenModeFlag)  {
