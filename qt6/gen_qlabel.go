...
// GetDecodedMetricF can only be called from a QLabel that was directly constructed.
func (this *QLabel) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QLabel_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QLabel) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QLabel_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QLabel) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QLabel_metric(self *C.QLabel, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
