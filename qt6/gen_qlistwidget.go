...
func (this *QListWidget) SetSupportedDragActions(actions DropAction) {
	C.QListWidget_setSupportedDragActions(this.h, (C.int)(actions))
}

func (this *QListWidget) SupportedDragActions() DropAction {
	return (DropAction)(C.QListWidget_supportedDragActions(this.h))
}
...
func (this *QListWidget) State() State {
...
func (this *QListWidget) SetState(state State) {

	var _dynamic_cast_ok C.bool = false
	C.QListWidget_protectedbase_setState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
...
func (this *QListWidget) DropIndicatorPosition() DropIndicatorPosition {
...
// GetDecodedMetricF can only be called from a QListWidget that was directly constructed.
func (this *QListWidget) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QListWidget_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QListWidget) callVirtualBase_ScrollTo(index *QModelIndex, hint ScrollHint) {
	...
	C.QListWidget_virtualbase_scrollTo(unsafe.Pointer(this.h), index.cPointer(), hint)
...
func miqt_exec_callback_QListWidget_scrollTo(self *C.QListWidget, cb C.intptr_t, index *C.QModelIndex, hint C.ScrollHint) {
...
func (this *QListWidget) callVirtualBase_MoveCursor(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex {
	...
	_goptr := newQModelIndex(C.QListWidget_virtualbase_moveCursor(unsafe.Pointer(this.h), cursorAction, (C.int)(modifiers)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func miqt_exec_callback_QListWidget_moveCursor(self *C.QListWidget, cb C.intptr_t, cursorAction C.CursorAction, modifiers C.int) *C.QModelIndex {
...
func (this *QListWidget) callVirtualBase_Edit2(index *QModelIndex, trigger EditTrigger, event *QEvent) bool {

	return (bool)(C.QListWidget_virtualbase_edit2(unsafe.Pointer(this.h), index.cPointer(), trigger, event.cPointer()))

}
func (this *QListWidget) OnEdit2(slot func(super func(index *QModelIndex, trigger EditTrigger, event *QEvent) bool, index *QModelIndex, trigger EditTrigger, event *QEvent) bool) {
...
func miqt_exec_callback_QListWidget_edit2(self *C.QListWidget, cb C.intptr_t, index *C.QModelIndex, trigger C.EditTrigger, event *C.QEvent) C.bool {
...
func (this *QListWidget) callVirtualBase_SelectionCommand(index *QModelIndex, event *QEvent) SelectionFlag {

	return (SelectionFlag)(C.QListWidget_virtualbase_selectionCommand(unsafe.Pointer(this.h), index.cPointer(), event.cPointer()))

}
func (this *QListWidget) OnSelectionCommand(slot func(super func(index *QModelIndex, event *QEvent) SelectionFlag, index *QModelIndex, event *QEvent) SelectionFlag) {
...
func (this *QListWidget) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QListWidget_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QListWidget) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QListWidget_metric(self *C.QListWidget, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
