...
// GetDecodedMetricF can only be called from a QMenuBar that was directly constructed.
func (this *QMenuBar) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QMenuBar_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QMenuBar) callVirtualBase_Metric(param1 PaintDeviceMetric) int {
	...
	return (int)(C.QMenuBar_virtualbase_metric(unsafe.Pointer(this.h), param1))
...
func miqt_exec_callback_QMenuBar_metric(self *C.QMenuBar, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
