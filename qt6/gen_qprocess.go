...
QProcess__CrashExit QProcess__ExitStatus = 1
		...
		type QProcess__UnixProcessFlag uint
		const (
QProcess__ResetSignalHandlers QProcess__UnixProcessFlag = 1
QProcess__IgnoreSigPipe QProcess__UnixProcessFlag = 2
QProcess__CloseFileDescriptors QProcess__UnixProcessFlag = 16
QProcess__UseVFork QProcess__UnixProcessFlag = 32
QProcess__CreateNewSession QProcess__UnixProcessFlag = 64
QProcess__DisconnectControllingTerminal QProcess__UnixProcessFlag = 128
QProcess__ResetIds QProcess__UnixProcessFlag = 256
QProcess__DisableCoreDumps QProcess__UnixProcessFlag = 512
		...
		func (this *QProcessEnvironment) UnsafePointer() unsafe.Pointer {
			...
			func NewQProcessEnvironment2(param1 Initialization) *QProcessEnvironment {
				...
				return newQProcessEnvironment(C.QProcessEnvironment_new2(param1))
			}
...
defer C.free(unsafe.Pointer(command_ms.data))
 C.QProcess_startCommand(this.h, command_ms)
			...
			func (this *QProcess) Open(mode OpenMode) bool {
				return (bool)(C.QProcess_open(this.h, mode))
}
...
arguments_ma := C.struct_miqt_array{len: C.size_t(len(arguments)), data: unsafe.Pointer(arguments_CArray)}
 C.QProcess_setArguments(this.h, arguments_ma)
			...
			func (this *QProcess) SetProcessChannelMode(mode ProcessChannelMode)  {
				 C.QProcess_setProcessChannelMode(this.h, mode)
}
			...
			func (this *QProcess) SetInputChannelMode(mode InputChannelMode)  {
				 C.QProcess_setInputChannelMode(this.h, mode)
}
			...
			func (this *QProcess) SetReadChannel(channel ProcessChannel)  {
				 C.QProcess_setReadChannel(this.h, channel)
}
			
			func (this *QProcess) CloseReadChannel(channel ProcessChannel)  {
				 C.QProcess_closeReadChannel(this.h, channel)
}
...
defer C.free(unsafe.Pointer(fileName_ms.data))
 C.QProcess_setStandardErrorFile(this.h, fileName_ms)
			...
			func (this *QProcess) FailChildProcessModifier(description string)  {
				description_Cstring := C.CString(description)
defer C.free(unsafe.Pointer(description_Cstring))
 C.QProcess_failChildProcessModifier(this.h, description_Cstring)
}
			
			func (this *QProcess) UnixProcessParameters() UnixProcessParameters {
				int /* TODO  */}
			
			func (this *QProcess) SetUnixProcessParameters(params *UnixProcessParameters)  {
				 C.QProcess_setUnixProcessParameters(this.h, params)
}
			
			func (this *QProcess) SetUnixProcessParametersWithFlagsOnly(flagsOnly UnixProcessFlags)  {
				 C.QProcess_setUnixProcessParametersWithFlagsOnly(this.h, flagsOnly)
}
...
arguments_ma := C.struct_miqt_array{len: C.size_t(len(arguments)), data: unsafe.Pointer(arguments_CArray)}
 C.QProcess_start3(this.h, program_ms, arguments_ma)
			...
			func (this *QProcess) Start4(program string, arguments []string, mode OpenMode)  {
				program_ms := C.struct_miqt_string{}
program_ms.data = C.CString(program)
program_ms.len = C.size_t(len(program))
defer C.free(unsafe.Pointer(program_ms.data))
...
arguments_ma := C.struct_miqt_array{len: C.size_t(len(arguments)), data: unsafe.Pointer(arguments_CArray)}
 C.QProcess_start4(this.h, program_ms, arguments_ma, mode)
}
			
			func (this *QProcess) StartWithMode(mode OpenMode)  {
				 C.QProcess_startWithMode(this.h, mode)
}
...
command_ms.len = C.size_t(len(command))
defer C.free(unsafe.Pointer(command_ms.data))
 C.QProcess_startCommand2(this.h, command_ms, mode)
}
...
fileName_ms.len = C.size_t(len(fileName))
defer C.free(unsafe.Pointer(fileName_ms.data))
 C.QProcess_setStandardOutputFile2(this.h, fileName_ms, mode)
}
...
fileName_ms.len = C.size_t(len(fileName))
defer C.free(unsafe.Pointer(fileName_ms.data))
 C.QProcess_setStandardErrorFile2(this.h, fileName_ms, mode)
}
			
			func (this *QProcess) FailChildProcessModifier2(description string, error int)  {
				description_Cstring := C.CString(description)
defer C.free(unsafe.Pointer(description_Cstring))
 C.QProcess_failChildProcessModifier2(this.h, description_Cstring, (C.int)(error))
}
...
slotval2 := (QProcess__ExitStatus)(exitStatus)
			...
			func (this *QProcess) SetProcessState (state ProcessState)  {
				
				var _dynamic_cast_ok C.bool = false
				 C.QProcess_protectedbase_setProcessState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
			...
			func (this *QProcess) SetOpenMode (openMode OpenModeFlag)  {
...
defer C.free(unsafe.Pointer(signal_Cstring))
			...
			func (this *QProcess) IsSignalConnected (signal *QMetaMethod) bool {
				...
				func (this *QProcess) callVirtualBase_Open(mode OpenMode) bool {
					...
					return (bool)(C.QProcess_virtualbase_open(unsafe.Pointer(this.h), mode))
				...
				func miqt_exec_callback_QProcess_open(self *C.QProcess, cb C.intptr_t, mode C.OpenMode) C.bool{
...
gofunc((&QProcess{h: self}).callVirtualBase_DisconnectNotify, slotval1 )
		...
		type QProcess__UnixProcessParameters struct {
			h *C.QProcess__UnixProcessParameters
		
		}
		
		func (this *QProcess__UnixProcessParameters) cPointer() *C.QProcess__UnixProcessParameters {
			if this == nil {
				return nil
			}
			return this.h
		...
		func (this *QProcess__UnixProcessParameters) UnsafePointer() unsafe.Pointer {
			if this == nil {
				return nil
			}
			return unsafe.Pointer(this.h)
			...
			// newQProcess__UnixProcessParameters constructs the type using only CGO pointers.
			func newQProcess__UnixProcessParameters(h *C.QProcess__UnixProcessParameters) *QProcess__UnixProcessParameters {
				if h == nil {
					return nil
				}
		
				return &QProcess__UnixProcessParameters{h: h}
			}

			// UnsafeNewQProcess__UnixProcessParameters constructs the type using only unsafe pointers.
			func UnsafeNewQProcess__UnixProcessParameters(h unsafe.Pointer) *QProcess__UnixProcessParameters {
				return newQProcess__UnixProcessParameters( (*C.QProcess__UnixProcessParameters)(h) )
			}

		
			func (this *QProcess__UnixProcessParameters) Flags() UnixProcessFlags {
				int /* TODO  */}
			
			func (this *QProcess__UnixProcessParameters) SetFlags(flags UnixProcessFlags)  {
				 C.QProcess__UnixProcessParameters_setFlags(this.h, flags)
}
			
			func (this *QProcess__UnixProcessParameters) LowestFileDescriptorToClose() int {
				return (int)(C.QProcess__UnixProcessParameters_lowestFileDescriptorToClose(this.h))
}
			
			func (this *QProcess__UnixProcessParameters) SetLowestFileDescriptorToClose(lowestFileDescriptorToClose int)  {
				 C.QProcess__UnixProcessParameters_setLowestFileDescriptorToClose(this.h, (C.int)(lowestFileDescriptorToClose))
}
			
			func (this *QProcess__UnixProcessParameters) Reserved() quint32[6] {
				int /* TODO  */}
			
			func (this *QProcess__UnixProcessParameters) SetReserved(_reserved quint32[6])  {
				 C.QProcess__UnixProcessParameters_setReserved(this.h, _reserved)
}
			
			// Delete this object from C++ memory.
			func (this *QProcess__UnixProcessParameters) Delete() {
				C.QProcess__UnixProcessParameters_delete(this.h)
			}

			// GoGC adds a Go Finalizer to this pointer, so that it will be deleted
			// from C++ memory once it is unreachable from Go memory.
			func (this *QProcess__UnixProcessParameters) GoGC() {
				runtime.SetFinalizer(this, func(this *QProcess__UnixProcessParameters) {
					this.Delete()
					runtime.KeepAlive(this.h)
				})
			}
