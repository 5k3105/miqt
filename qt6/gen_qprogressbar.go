...
// GetDecodedMetricF can only be called from a QProgressBar that was directly constructed.
func (this *QProgressBar) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QProgressBar_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QProgressBar) callVirtualBase_Metric(param1 PaintDeviceMetric) int {
	...
	return (int)(C.QProgressBar_virtualbase_metric(unsafe.Pointer(this.h), param1))
...
func miqt_exec_callback_QProgressBar_metric(self *C.QProgressBar, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
