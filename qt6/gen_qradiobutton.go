...
// GetDecodedMetricF can only be called from a QRadioButton that was directly constructed.
func (this *QRadioButton) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QRadioButton_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QRadioButton) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QRadioButton_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QRadioButton) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QRadioButton_metric(self *C.QRadioButton, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
