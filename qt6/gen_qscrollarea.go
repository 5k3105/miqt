...
// GetDecodedMetricF can only be called from a QScrollArea that was directly constructed.
func (this *QScrollArea) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QScrollArea_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QScrollArea) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QScrollArea_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QScrollArea) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QScrollArea_metric(self *C.QScrollArea, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
