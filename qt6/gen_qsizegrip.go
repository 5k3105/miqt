...
// GetDecodedMetricF can only be called from a QSizeGrip that was directly constructed.
func (this *QSizeGrip) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QSizeGrip_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QSizeGrip) callVirtualBase_Metric(param1 PaintDeviceMetric) int {
	...
	return (int)(C.QSizeGrip_virtualbase_metric(unsafe.Pointer(this.h), param1))
...
func miqt_exec_callback_QSizeGrip_metric(self *C.QSizeGrip, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
