...
int miqt_exec_callback_QStatusBar_metric(const QStatusBar*, intptr_t, PaintDeviceMetric);
...
public:
	...
	friend int QStatusBar_virtualbase_metric(const void* self, PaintDeviceMetric param1);
	...
	friend double QStatusBar_protectedbase_getDecodedMetricF(bool* _dynamic_cast_ok, const void* self, PaintDeviceMetric metricA, PaintDeviceMetric metricB);
};
...
int QStatusBar_virtualbase_metric(const void* self, PaintDeviceMetric param1) {
	return static_cast<const MiqtVirtualQStatusBar*>(self)->QStatusBar::metric(param1);
}
