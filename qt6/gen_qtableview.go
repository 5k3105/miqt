...
func (this *QTableView) ScrollTo(index *QModelIndex, hint ScrollHint) {
	C.QTableView_scrollTo(this.h, index.cPointer(), hint)
}
...
func (this *QTableView) State() State {
...
func (this *QTableView) SetState(state State) {

	var _dynamic_cast_ok C.bool = false
	C.QTableView_protectedbase_setState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
...
func (this *QTableView) DropIndicatorPosition() DropIndicatorPosition {
...
// GetDecodedMetricF can only be called from a QTableView that was directly constructed.
func (this *QTableView) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QTableView_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QTableView) callVirtualBase_ScrollTo(index *QModelIndex, hint ScrollHint) {
	...
	C.QTableView_virtualbase_scrollTo(unsafe.Pointer(this.h), index.cPointer(), hint)
...
func miqt_exec_callback_QTableView_scrollTo(self *C.QTableView, cb C.intptr_t, index *C.QModelIndex, hint C.ScrollHint) {
...
func (this *QTableView) callVirtualBase_MoveCursor(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex {
	...
	_goptr := newQModelIndex(C.QTableView_virtualbase_moveCursor(unsafe.Pointer(this.h), cursorAction, (C.int)(modifiers)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func miqt_exec_callback_QTableView_moveCursor(self *C.QTableView, cb C.intptr_t, cursorAction C.CursorAction, modifiers C.int) *C.QModelIndex {
...
func (this *QTableView) callVirtualBase_Edit2(index *QModelIndex, trigger EditTrigger, event *QEvent) bool {
	...
	return (bool)(C.QTableView_virtualbase_edit2(unsafe.Pointer(this.h), index.cPointer(), trigger, event.cPointer()))
...
func miqt_exec_callback_QTableView_edit2(self *C.QTableView, cb C.intptr_t, index *C.QModelIndex, trigger C.EditTrigger, event *C.QEvent) C.bool {
...
func (this *QTableView) callVirtualBase_SelectionCommand(index *QModelIndex, event *QEvent) SelectionFlag {
	...
	return (SelectionFlag)(C.QTableView_virtualbase_selectionCommand(unsafe.Pointer(this.h), index.cPointer(), event.cPointer()))
...
func (this *QTableView) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QTableView_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QTableView) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QTableView_metric(self *C.QTableView, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
