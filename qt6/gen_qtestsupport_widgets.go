...
func NewQTest__QTouchEventWidgetSequence(param1 *QTouchEventWidgetSequence) *QTest__QTouchEventWidgetSequence {
	...
	return newQTest__QTouchEventWidgetSequence(C.QTest__QTouchEventWidgetSequence_new(param1))
}
...
func (this *QTest__QTouchEventWidgetSequence) OperatorAssign(param1 *QTouchEventWidgetSequence) {
	C.QTest__QTouchEventWidgetSequence_operatorAssign(this.h, param1)
}

func (this *QTest__QTouchEventWidgetSequence) Press2(touchId int, pt *QPoint, widget *QWidget) *QTouchEventWidgetSequence {
	int /* TODO  */
}

func (this *QTest__QTouchEventWidgetSequence) Move2(touchId int, pt *QPoint, widget *QWidget) *QTouchEventWidgetSequence {
	int /* TODO  */
}

func (this *QTest__QTouchEventWidgetSequence) Release2(touchId int, pt *QPoint, widget *QWidget) *QTouchEventWidgetSequence {
	int /* TODO  */
}
...
func miqt_exec_callback_QTest__QTouchEventWidgetSequence_stationary(self *C.QTest__QTouchEventWidgetSequence, cb C.intptr_t, touchId C.int) *C.QTouchEventWidgetSequence {
