...
// GetDecodedMetricF can only be called from a QToolBox that was directly constructed.
func (this *QToolBox) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QToolBox_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QToolBox) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QToolBox_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QToolBox) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QToolBox_metric(self *C.QToolBox, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
