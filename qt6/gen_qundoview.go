...
func (this *QUndoView) State() State {
...
func (this *QUndoView) SetState(state State) {

	var _dynamic_cast_ok C.bool = false
	C.QUndoView_protectedbase_setState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
...
func (this *QUndoView) DropIndicatorPosition() DropIndicatorPosition {
...
// GetDecodedMetricF can only be called from a QUndoView that was directly constructed.
func (this *QUndoView) GetDecodedMetricF(metricA PaintDeviceMetric, metricB PaintDeviceMetric) float64 {

	var _dynamic_cast_ok C.bool = false
	_method_ret := (float64)(C.QUndoView_protectedbase_getDecodedMetricF(&_dynamic_cast_ok, unsafe.Pointer(this.h), metricA, metricB))
...
func (this *QUndoView) callVirtualBase_ScrollTo(index *QModelIndex, hint ScrollHint) {
	...
	C.QUndoView_virtualbase_scrollTo(unsafe.Pointer(this.h), index.cPointer(), hint)
...
func miqt_exec_callback_QUndoView_scrollTo(self *C.QUndoView, cb C.intptr_t, index *C.QModelIndex, hint C.ScrollHint) {
...
func (this *QUndoView) callVirtualBase_MoveCursor(cursorAction CursorAction, modifiers KeyboardModifier) *QModelIndex {
	...
	_goptr := newQModelIndex(C.QUndoView_virtualbase_moveCursor(unsafe.Pointer(this.h), cursorAction, (C.int)(modifiers)))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr
...
func miqt_exec_callback_QUndoView_moveCursor(self *C.QUndoView, cb C.intptr_t, cursorAction C.CursorAction, modifiers C.int) *C.QModelIndex {
...
func (this *QUndoView) callVirtualBase_Edit2(index *QModelIndex, trigger EditTrigger, event *QEvent) bool {

	return (bool)(C.QUndoView_virtualbase_edit2(unsafe.Pointer(this.h), index.cPointer(), trigger, event.cPointer()))

}
func (this *QUndoView) OnEdit2(slot func(super func(index *QModelIndex, trigger EditTrigger, event *QEvent) bool, index *QModelIndex, trigger EditTrigger, event *QEvent) bool) {
...
func miqt_exec_callback_QUndoView_edit2(self *C.QUndoView, cb C.intptr_t, index *C.QModelIndex, trigger C.EditTrigger, event *C.QEvent) C.bool {
...
func (this *QUndoView) callVirtualBase_SelectionCommand(index *QModelIndex, event *QEvent) SelectionFlag {

	return (SelectionFlag)(C.QUndoView_virtualbase_selectionCommand(unsafe.Pointer(this.h), index.cPointer(), event.cPointer()))

}
func (this *QUndoView) OnSelectionCommand(slot func(super func(index *QModelIndex, event *QEvent) SelectionFlag, index *QModelIndex, event *QEvent) SelectionFlag) {
...
func (this *QUndoView) callVirtualBase_Metric(param1 PaintDeviceMetric) int {

	return (int)(C.QUndoView_virtualbase_metric(unsafe.Pointer(this.h), param1))

}
func (this *QUndoView) OnMetric(slot func(super func(param1 PaintDeviceMetric) int, param1 PaintDeviceMetric) int) {
...
func miqt_exec_callback_QUndoView_metric(self *C.QUndoView, cb C.intptr_t, param1 C.PaintDeviceMetric) C.int {
