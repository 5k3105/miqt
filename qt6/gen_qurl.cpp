...
QUrl* QUrl_new4(struct miqt_string url, ParsingMode mode) {
	QString url_QString = QString::fromUtf8(url.data, url.len);
	return new (std::nothrow) QUrl(url_QString, mode);
}
...
struct miqt_string QUrl_urlWithOptions(const QUrl* self, FormattingOptions options) {
...
struct miqt_string QUrl_toStringWithOptions(const QUrl* self, FormattingOptions options) {
...
struct miqt_string QUrl_toDisplayStringWithOptions(const QUrl* self, FormattingOptions options) {
...
struct miqt_string QUrl_toEncodedWithOptions(const QUrl* self, FormattingOptions options) {
...
struct miqt_string QUrl_authorityWithOptions(const QUrl* self, ComponentFormattingOptions options) {
...
struct miqt_string QUrl_userInfoWithOptions(const QUrl* self, ComponentFormattingOptions options) {
...
struct miqt_string QUrl_userNameWithOptions(const QUrl* self, ComponentFormattingOptions options) {
...
struct miqt_string QUrl_passwordWithComponentFormattingOptions(const QUrl* self, ComponentFormattingOptions param1) {
...
struct miqt_string QUrl_hostWithComponentFormattingOptions(const QUrl* self, ComponentFormattingOptions param1) {
...
struct miqt_string QUrl_pathWithOptions(const QUrl* self, ComponentFormattingOptions options) {
...
struct miqt_string QUrl_fileNameWithOptions(const QUrl* self, ComponentFormattingOptions options) {
...
struct miqt_string QUrl_queryWithComponentFormattingOptions(const QUrl* self, ComponentFormattingOptions param1) {
...
struct miqt_string QUrl_fragmentWithOptions(const QUrl* self, ComponentFormattingOptions options) {
