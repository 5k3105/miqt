...
func (this *QTcpSocket) Bind3(addr QHostAddress__SpecialAddress, port uint16, mode BindMode) bool {
	return (bool)(C.QTcpSocket_bind3(this.h, (C.int)(addr), (C.ushort)(port), mode))
}

// SetSocketState can only be called from a QTcpSocket that was directly constructed.
func (this *QTcpSocket) SetSocketState(state SocketState) {

	var _dynamic_cast_ok C.bool = false
	C.QTcpSocket_protectedbase_setSocketState(&_dynamic_cast_ok, unsafe.Pointer(this.h), state)
...
func (this *QTcpSocket) SetSocketError(socketError SocketError) {

	var _dynamic_cast_ok C.bool = false
	C.QTcpSocket_protectedbase_setSocketError(&_dynamic_cast_ok, unsafe.Pointer(this.h), socketError)
...
func (this *QTcpSocket) SetOpenMode(openMode OpenModeFlag) {
...
func (this *QTcpSocket) callVirtualBase_Bind(address *QHostAddress, port uint16, mode BindMode) bool {
	...
	return (bool)(C.QTcpSocket_virtualbase_bind(unsafe.Pointer(this.h), address.cPointer(), (C.ushort)(port), mode))
...
func miqt_exec_callback_QTcpSocket_bind(self *C.QTcpSocket, cb C.intptr_t, address *C.QHostAddress, port C.ushort, mode C.BindMode) C.bool {
...
func (this *QTcpSocket) callVirtualBase_ConnectToHost(hostName string, port uint16, mode OpenMode, protocol NetworkLayerProtocol) {
	...
	C.QTcpSocket_virtualbase_connectToHost(unsafe.Pointer(this.h), hostName_ms, (C.ushort)(port), mode, protocol)
...
func miqt_exec_callback_QTcpSocket_connectToHost(self *C.QTcpSocket, cb C.intptr_t, hostName C.struct_miqt_string, port C.ushort, mode C.OpenMode, protocol C.NetworkLayerProtocol) {
...
func (this *QTcpSocket) callVirtualBase_SetSocketDescriptor(socketDescriptor uintptr, state SocketState, openMode OpenMode) bool {
	...
	return (bool)(C.QTcpSocket_virtualbase_setSocketDescriptor(unsafe.Pointer(this.h), (C.intptr_t)(socketDescriptor), state, openMode))
...
func miqt_exec_callback_QTcpSocket_setSocketDescriptor(self *C.QTcpSocket, cb C.intptr_t, socketDescriptor C.intptr_t, state C.SocketState, openMode C.OpenMode) C.bool {
...
func (this *QTcpSocket) callVirtualBase_Open(mode OpenModeFlag) bool {

	return (bool)(C.QTcpSocket_virtualbase_open(unsafe.Pointer(this.h), (C.int)(mode)))

}
func (this *QTcpSocket) OnOpen(slot func(super func(mode OpenModeFlag) bool, mode OpenModeFlag) bool) {
