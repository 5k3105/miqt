...
func (this *QGraphicsSvgItem) callVirtualBase_ItemChange(change GraphicsItemChange, value *qt6.QVariant) *qt6.QVariant {

	_goptr := qt6.UnsafeNewQVariant(unsafe.Pointer(C.QGraphicsSvgItem_virtualbase_itemChange(unsafe.Pointer(this.h), change, (*C.QVariant)(value.UnsafePointer()))))
	_goptr.GoGC() // Qt uses pass-by-value semantics for this type. Mimic with finalizer
	return _goptr

}
func (this *QGraphicsSvgItem) OnItemChange(slot func(super func(change GraphicsItemChange, value *qt6.QVariant) *qt6.QVariant, change GraphicsItemChange, value *qt6.QVariant) *qt6.QVariant) {
...
func miqt_exec_callback_QGraphicsSvgItem_itemChange(self *C.QGraphicsSvgItem, cb C.intptr_t, change C.GraphicsItemChange, value *C.QVariant) *C.QVariant {
...
func (this *QGraphicsSvgItem) callVirtualBase_SupportsExtension(extension Extension) bool {

	return (bool)(C.QGraphicsSvgItem_virtualbase_supportsExtension(unsafe.Pointer(this.h), extension))

}
func (this *QGraphicsSvgItem) OnSupportsExtension(slot func(super func(extension Extension) bool, extension Extension) bool) {
...
func miqt_exec_callback_QGraphicsSvgItem_supportsExtension(self *C.QGraphicsSvgItem, cb C.intptr_t, extension C.Extension) C.bool {
...
func (this *QGraphicsSvgItem) callVirtualBase_SetExtension(extension Extension, variant *qt6.QVariant) {

	C.QGraphicsSvgItem_virtualbase_setExtension(unsafe.Pointer(this.h), extension, (*C.QVariant)(variant.UnsafePointer()))

}
func (this *QGraphicsSvgItem) OnSetExtension(slot func(super func(extension Extension, variant *qt6.QVariant), extension Extension, variant *qt6.QVariant)) {
...
func miqt_exec_callback_QGraphicsSvgItem_setExtension(self *C.QGraphicsSvgItem, cb C.intptr_t, extension C.Extension, variant *C.QVariant) {
